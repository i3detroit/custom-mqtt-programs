...
void loop()
{
  ...
  if (millis() - outLoopTimer >= 2000)
  {
    ...
    Serial.print(windSpeed*1.492*0.621371);
    Serial.println(" kph");
    ...
    Serial.println(float(rainLastHour)*0.011*0.393701, 3);
    Serial.print("Rainfall last day: ");
    Serial.println(float(rainLastDay)*0.011*0.393701, 3);
    Serial.print("Rainfall to date: ");
    Serial.println(float(rainTicks)*0.011*0.393701, 3);
  ...
  wundergroundUpdateTimer = millis();
    ...
    url += "&baromin=";
    float baromin = bme.readFloatPressure();
    url += baromin;
